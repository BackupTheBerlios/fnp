...
<tr><td><font face=Verdana size=2 color=#000000>FROM (ICAO code)&nbsp;</td><td><input type="text" value ="EDTF%PRE_FROM%" name="from" size="4" maxlength="4"></td></tr>
<tr><td><font face=Verdana size=2 color=#000000>TO (ICAO code)</td><td><input type="text" name="to" value ="ETNL%PRE_TO%" size="4" maxlength="4"></td></tr>
